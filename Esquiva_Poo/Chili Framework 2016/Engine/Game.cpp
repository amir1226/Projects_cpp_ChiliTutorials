...
void Game::UpdateModel()
{
	...
	{
		Thedude.y = Thedude.y - Thedude.vy;
	}
	...
	{
		Thedude.x = Thedude.x + Thedude.vx;
	}
	...
	if (Poo0.dudeTouch(Thedude.x, Thedude.y, Thedude.width, Thedude.height) ||
		Poo1.dudeTouch(Thedude.x, Thedude.y, Thedude.width, Thedude.height) ||
		Poo2.dudeTouch(Thedude.x, Thedude.y, Thedude.width, Thedude.height) ||
		Poo3.dudeTouch(Thedude.x, Thedude.y, Thedude.width, Thedude.height) ||
		Poo4.dudeTouch(Thedude.x, Thedude.y, Thedude.width, Thedude.height) ||
		Poo5.dudeTouch(Thedude.x, Thedude.y, Thedude.width, Thedude.height ))
	{
		finish = true;
	}
...
void Game::dudeDraw(int x, int y)
{
...
void Game::gameOVerDraw(int x, int y)
{
...
void Game::ComposeFrame()
{
	if (finish)
	{
		gameOVerDraw(400, 300);
	}
	else
	{
		dudeDraw(Thedude.x, Thedude.y);

		if (Poo0.sum == 0) 
		{
			pooDraw(Poo0.x, Poo0.y);
		}
		else if (Poo0.sum == 1)
		{
			pooDraw(Poo0.x, Poo0.y);
			pooDraw(Poo1.x, Poo1.y);
